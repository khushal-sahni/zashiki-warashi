---
slug: compose-databases
title: "Peek Docker Compose databases locally — Zashiki Warashi"
h1: "Compose and database peek"
description: "Peek Docker Compose DB services from a macOS project catalog: host, port, user, database, copy URI, open MongoDB Compass — without becoming a Docker GUI."
lede: "Zashiki Warashi finds Compose files in a project, lists DB-like services, and helps you copy a connection URI or open Compass — glue on top of Docker Desktop or OrbStack."
related:
  - /mongodb-compass/
  - /start-stop/
  - /compare/portainer/
faq:
  - q: "Does this replace Portainer or Docker Desktop?"
    a: "No. It peeks and drives compose for DB-like services as part of a project house. Full container management stays with your engine UI."
  - q: "Are database passwords stored in SQLite?"
    a: "No. URIs are derived at runtime from compose/env. Passwords are not persisted; the UI masks secrets."
  - q: "How deep does compose discovery go?"
    a: "Root plus nested compose within a shallow depth (including common nested layouts). Nested compose -f is supported for logs and stack actions."
---
