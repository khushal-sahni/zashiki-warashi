---
slug: compare/portainer
title: "Zashiki Warashi vs Portainer — Docker UI vs project house"
h1: "vs Portainer"
description: "Portainer is a Docker/container management UI (often remote). Zashiki Warashi is a macOS-local project catalog with process start/stop and Compose DB peek — not a Portainer replacement."
lede: "Portainer manages containers and environments. Zashiki manages the developer’s local project pile and glues into Docker only where Compose databases matter."
related:
  - /compose-databases/
  - /compare/docker-desktop/
  - /localhost-control-plane/
faq:
  - q: "Can Zashiki manage remote Docker hosts?"
    a: "Not in v1. It is machine-local. Remote/SSH hosts are future ideas, not current scope."
  - q: "Does Zashiki edit Compose YAML visually?"
    a: "No. Peek and up/stop for DB-like services; editing stays in your editor."
  - q: "I only need local compose up/down — is Portainer overkill?"
    a: "Often yes. If your pain is multi-repo localhost plus occasional compose DBs, a project house may fit better than a full Docker UI."
---
