---
slug: localhost-control-plane
title: "What is a localhost control plane? — Zashiki Warashi"
h1: "A control plane for localhost"
description: "Zashiki Warashi is a macOS control plane for local projects: catalog, start/stop, Compose/DB peek, and deep-links — not a Docker GUI, not Raycast, not a folder bookmark."
lede: "A control plane for localhost is one place that knows your local projects and can operate them — without becoming the editor, the runtime, or the database GUI."
related:
  - /for-ai-projects/
  - /start-stop/
  - /compose-databases/
faq:
  - q: "How is this different from Raycast or Spotlight?"
    a: "Launchers open things. A control plane remembers project state, starts and stops processes, and peeks stack endpoints. Zashiki keeps a catalog and lifecycle, not only shortcuts."
  - q: "Do I need cloud accounts?"
    a: "No. Catalog and overrides stay on your Mac. No sync, no login."
  - q: "Does it replace Docker Desktop?"
    a: "No. Docker Desktop or OrbStack remain the engine for containers. Zashiki peeks and drives compose for DB-like services as glue."
---
